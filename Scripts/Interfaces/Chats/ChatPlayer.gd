...
var presentEvidenceMinji = load("res://Resources/Dialogue/Minji/Minji-PresentEvidence.dialogue")
var presentEvidenceJames = load("res://Resources/Dialogue/James/James-PresentEvidence.dialogue")
var presentEvidenceAmelia = load("res://Resources/Dialogue/Amelia/Amelia-PresentEvidence.dialogue")
var presentEvidenceApril = load("res://Resources/Dialogue/April/April-PresentEvidence.dialogue")
var presentEvidenceCalvin = load("res://Resources/Dialogue/Calvin/Calvin-PresentEvidence.dialogue")
var presentEvidenceNoah = load("res://Resources/Dialogue/Noah/Noah-PresentEvidence.dialogue")
var presentEvidencePaige = load("res://Resources/Dialogue/Paige/Paige-PresentEvidence.dialogue")
...
func showChat(chat:Chatroom, gameManagerPassed:GameManager):
	...
	if ( gameManager.presentEvidenceUnlocked ):
